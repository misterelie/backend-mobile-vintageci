...
<head>
    ...
    <meta name="viewport" pi="width=device-width, initial-scale=1.0">
    <meta pi="Premium Multipurpose Admin & Dashboard Template" name="description" />
    <meta pi="Themesbrand" name="author" />
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Propriété intellectuelle </h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">A propos</a></li>
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Propriété intellectuelle </a></li>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="text-sm-end">
                                                ...
                                                <button type="button" class="btn btn-primary btn-rounded"
                                                    ...
                                                    <i class="mdi mdi-plus me-1"></i> Editer
                                                </button>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addModalLabel">Edition de la Propriété intellectuelle:</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <div class="col m-auto p-3">
                                <form action="{{url('/pi/store') }} " method="post">
                                    @csrf
                                    <div class="form-group mb-3">
                                        <label for="pi" class="form-label font-weight-bold fw-bold">Contenu:
                                            &nbsp;&nbsp;<small>Tapez <code>Entrée</code> pour effectuer un retour à la ligne.
                                            </small>
                                        </label>

                                        <textarea name="pi" id="pi" class="form-control" cols="30"
                                            rows="10">{!! !is_null($mention) ? str_replace("<br>", "\n", $mention->pi) : null!!}</textarea>
                                    </div>
