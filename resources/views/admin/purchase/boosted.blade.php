                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Annonces VIP</h4>
                                            ...
                                            <table class="table align-middle table-nowrap table-check">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th class="align-middle text-uppercase">Durée</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ url('backend/single', $cat->pk)}} ">
                                                                <strong>{{ Str::substr(Str::ucfirst($cat->titre), 0, 10)."..." }} </strong>
                                                            </a>
                                                        ...
                                                        <td>
                                                            {{ Dates::formatFr($cat->date)}}
                                                            {{-- {{ Stat::delay($cat) }} --}}
                                                        </td>
                                                        <td>
                                                            <b>{{ Dates::moneyFormat($cat->duree)}}</b> Jrs
                                                        </td>
                                                         <td>
                                                            {!! Helpers::vip_statut($cat->statut) !!}
                                                        </td>
                                                        <td>
                                                            <div class=" btn-group">
