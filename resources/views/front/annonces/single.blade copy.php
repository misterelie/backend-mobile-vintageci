...
<head>
    ...
    {{-- ShareThis Boutons de partage --}}
    <script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=633ad56fc2af2800193d4b82&product=inline-share-buttons" async="async"></script>
</head>
            ...
            <div class="row gutter-lg">
                ...
                <div class="main-content justify-content-center">
                    <div class="product product-single row justify-content-center">
                        ...
                        <div class="col-md-7  sticky-sidebar-wrapper mb-4 m md-5">
                            <div class="product-details sticky-sidebar" data-sticky-options="{'minWidth': 767}">
                                    ...
                                    <div class="product-meta">
                                        ...
                                        <div class="product-categories">
                                            ...
                                            <span class="product-category">
                                                <a href="#">
                                                    <strong>{{ !is_null($annonce->author) ? $annonce->author->user_firstname . " ". $annonce->author->user_lastname  : null}} </strong>
                                                </a>
                                            </span>
                                        </div>
                                        @endif
                                ...
                                <div class="product-price"><ins class="new-price">{{ Helpers::moneyFormat($annonce->prix)  }} F CFA</ins></div>
                                <hr class="product-divider">
                                ...
                                <div class="fix-bottom product-sticky-content sticky-content">
                                    <div class="product-form container">
                                        ...
                                        <a  href="tel:{{$annonce->author->user_phone}}" class="btn btn-primary text-white ">
                                ...
                                <div class="social-links-wrapper">
                                    <div class="social-links">
                                        <div class="social-icons social-no-color border-thin">
                                            ...
                                            {{-- End ShareThis plugins container --}}
                                        </div>
                                    </div>
                            ...
                            <div class="widget widget-icon-box mb-6">
                                ...
                                <div class="icon-box icon-box-side">
                                    ...
                                    <div class="icon-box-content">
                                        <h4 class="icon-box-title mb-4 text-underline">Consigne : </h4> 
