        ...
        <main class="main">
            ...
            <nav class="breadcrumb-nav mb-3 mt-2">
                <div class="container">
                    <ul class="breadcrumb bb-no">
                        ...
                        <li><a href="{{ url('/annonces') }}">Annonces: {{ $category->category }} </a></li>
                    </ul>
                </div>
            </nav>
            <!-- End of Breadcrumb -->
            ...
            <div class="page-content mb-10 mt-4">
                ...
                <div class="container m-auto mx-auto">
                    ...
                    <h2 class="title justify-content-center ls-normal mb-4 mt-10 pt-1 appear-animate pb-4">
                        {{ Str::ucfirst($category->category) }}
                    </h2>

                    @if (!is_null($annonces) && $annonces->count() > 0)
                        <div
                            class="product-wrapper row cols-xl-2 cols-sm-1 cols-xs-2 cols-1 mt-4 pb-3 w-100 position-relative">
                            {{-- OTHERS --}}
                            {{-- Produit item --}}
                                ...
                                <div class="product product-list ">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <div class="product-cat mt-3 ">
                                            <a
                                                href="#">{{ !is_null($an->category) ? $an->category->category : null }}
                                            </a>
                                        </div>
