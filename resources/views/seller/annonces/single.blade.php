...
<head>
    ...
    <meta property="og:image" content="{{ Helper::public_file($annonce->photo_1) }}" />
                            ...
                            <div class="product product-single row justify-content-center">
                                ...
                                <div class="col-md-7 mb-6   ">
                                    <div class="product-gallery product-gallery-sticky product-gallery-vertical">
                                        <div class="swiper-container product-single-swiper swiper-theme nav-inner">
                                            <div class="swiper-wrapper  gutter-no">
                                                @if (!is_null($annonce->photo_1))
                                                <div class="product-thumb-box">
                                                    <figure class="product-image">
                                                        <img src="{{ Helper::public_file($annonce->photo_1) }}" alt="{{$annonce->titre}}" id="expandedImg" style="width:100%">
                                                    </figure>
                                                </div>
                                                @endif
                                            </div>
                                        ...
                                        <div class="product-thumbs-wrap swiper-container">
                                            <div class="product-thumbs swiper-wrapper  cols-4 gutter-sm">
                                                @if (!is_null($annonce->photo_1))
                                                <div class="product-thumb ">
                                                    <img src="{{ Helper::public_file($annonce->photo_1) }} " alt="Product Thumb"
                                                        width="800" height="900" onclick="myFunction(this);">
                                                </div>
                                                @endif
                                                @if (!is_null($annonce->photo_2))
                                                <div class="product-thumb ">
                                                    <img src="{{ Helper::public_file($annonce->photo_2) }} " alt="Product Thumb"
                                                        width="800" height="900" onclick="myFunction(this);">
                                                </div>
                                                @endif
                                                @if (!is_null($annonce->photo_3))
                                                <div class="product-thumb ">
                                                    <img src="{{ Helper::public_file($annonce->photo_3) }} " alt="Product Thumb"
                                                        width="800" height="900" onclick="myFunction(this);">
                                                </div>
                                                @endif
                                                @if (!is_null($annonce->photo_4))
                                                <div class="product-thumb ">
                                                    <img src="{{ Helper::public_file($annonce->photo_4) }} " alt="Product Thumb"
                                                        width="800" height="900" onclick="myFunction(this);">
                                                </div>
                                                @endif
                                                ...
                                                <div class="product-thumb ">
                                                    <img src="{{ Helper::public_file($annonce->photo_5) }} " alt="Product Thumb"
                                                        width="800" height="900" onclick="myFunction(this);">
                                                </div>
                                                @endif
                                                ...
                                                <div class="product-thumb ">
                                                    <img src="{{ Helper::public_file($annonce->photo_6) }} " alt="Product Thumb"
                                                        width="800" height="900" onclick="myFunction(this);">
                                                </div>
                                                @endif
                                                ...
                                                <div class="product-thumb ">
                                                    <img src="{{ Helper::public_file($annonce->photo_7) }} " alt="Product Thumb"
                                                        width="800" height="900" onclick="myFunction(this);">
                                                </div>
                                                @endif
                                                ...
                                                <div class="product-thumb ">
                                                    <img src="{{ Helper::public_file($annonce->photo_8) }} " alt="Product Thumb"
                                                        width="800" height="900" onclick="myFunction(this);">
                                                </div>
                                                @endif
                                                ...
                                                <div class="product-thumb ">
                                                    <img src="{{ Helper::public_file($annonce->photo_9) }} " alt="Product Thumb"
                                                        width="800" height="900" onclick="myFunction(this);">
                                                </div>
                                                @endif
                                ...
                                <div class="col-md-5  sticky-sidebar-wrapper mb-4 m md-5">
                                    <div class="product-details sticky-sidebar" data-sticky-options="{'minWidth': 767}">
                                            ...
                                            <div class="product-meta">
                                                ...
                                                <div class="product-categories">
                                                    ...
                                                    <span class="product-category">
                                                        <a href="#">
                                                            <strong>{{ !is_null($annonce->author) ?
                                                                $annonce->author->user_firstname . ' ' .
                                                                $annonce->author->user_lastname : null }}
                                                            </strong>
                                                        </a>
                                                    </span>
                                                </div>
                                        ...
                                        <hr class="product-divider d-sm-none">

                                        <div class="product-price"><ins class="new-price">{{
                                                Helpers::moneyFormat($annonce->prix) }} F
                                                CFA</ins> @if(!is_null($annonce->prix_promo)) <span
                                                class="promo-label">(Promo)</span>@endif

                                            @if (!is_null($annonce->prix_promo))
                                            <div class="old-price d-ms-block">
                                                <del>{{ Helpers::moneyFormat($annonce->prix_promo) }} F</del>
                                            </div>
                                            @endif
                                        </div>
                                        <hr class="product-divider d-sm-none">
                                        ...
                                        <div class="fix-bottom product-sticky-content sticky-content">
                                            <div class="product-form container">
                                                ...
                                                @if (!is_null($annonce->author) &&
                                                !is_null($annonce->author->user_whatsapp))
                                                <a href="https://api.whatsapp.com/send?phone={{ $annonce->author->user_whatsapp }}&text=Bonjour! j'ai vu votre annonce {{ $annonce->titre }} sur Vintage.ci Svp, envoyez-moi plus de détails à ce sujet"
                                                    class="btn what btn-green mr-2 text-white mt-2 mb-2">
                                                ...
                                                @if (!is_null($annonce->author) &&
                                                !is_null($annonce->author->user_phone))
